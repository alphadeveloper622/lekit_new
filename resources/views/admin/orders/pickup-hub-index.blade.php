                    ...
                    <div class="card-body card-body-paddding">
                        <form method="POST" action="{{ route('pickup.hub.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="customer-by-ajax form-control selectric" value="{{old('user_id')}}" name="user_id" id ="user_id"  aria-hidden="true" >
                                        <option value="" selected>{{__('Select Manager')}}</option>

                                    @foreach($staffs as $staff)
                                        <option
                                                value="{{$staff->id}}">{{$staff->first_name}} {{$staff->last_name}}</option>
                                    @endforeach
                                </select>
