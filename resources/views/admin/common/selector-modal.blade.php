    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <div class="right">
                    @if (isset($modal_state) && $modal_state=='gallery')
                    <button type="button" class="btn btn-icon icon-left btn-outline-primary delete-selected" >{{ __('Delete') }}</button>
                    <button type="button" class="btn btn-icon icon-left btn-outline-primary close-selected" data-dismiss="modal">{{ __('Close') }}</button>
                    @else
