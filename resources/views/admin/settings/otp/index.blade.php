                                ...
                                <div class="col-md-10 middle card-body card-body-paddding">
                                    ...
                                    @endif
                                        <table class="table table-striped table-md">
                                            <tr>
                                                <td>{{ __('disable_otp_verification') }}</td>
                                                <td width="300">
                                                    <label class="custom-switch mt-2">
                                                        <input type="checkbox" name="custom-switch-checkbox"
                                                               value="setting-status-change/disable_otp_verification"
                                                               class="custom-switch-input status-change" {{ settingHelper('disable_otp_verification') == 1 ? 'checked' : ''}} />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="active_sms_provider" class="form-control selectric" id="active_sms_provider">
                                                ...
                                                @if(settingHelper('is_spagreen_sms_activated') == 1)
                                                    <option value="spagreen" {{ settingHelper('active_sms_provider') == 'spagreen' ? 'selected' : ''}}>{{ __('REVE Systems') }}</option>
                                                @endif
