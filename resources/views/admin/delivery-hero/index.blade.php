    ...
    <section class="section">
        <div class="section-body">
            <div class="d-flex justify-content-between">
                <div class="d-block">
                    <h2 class="section-title">{{ __('Drivers Lists') }}</h2>
                ...
                @if(hasPermission('delivery_hero_create'))
                    <div class="buttons add-button">
                        <a href="{{ route('delivery.hero.create') }}" class="btn btn-icon icon-left btn-outline-primary">
                            <i class="bx bx-plus"></i>{{ __('Add New Driver') }}</a>
                    </div>
                @endif
            </div>
            <div class="row">
                                                     ...
                                                     @if($value->is_user_banned == 0)
                                                         <a href="{{ route('user.ban', $value->id) }}"
                                                            class="dropdown-item has-icon"><i
                                                                 class='bx bx-lock'></i>{{ __('Ban This Driver') }}</a>
                                                     @else
                                                         <a href="{{ route('user.ban', $value->id) }}"
                                                            class="dropdown-item has-icon"><i
                                                                 class='bx bx-lock-open'></i>{{ __('Unban This Driver') }}
                                                         </a>
                                                     @endif
                                                 @endif
