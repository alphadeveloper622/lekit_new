...
@section('stores_category_active')
active
@endsection
            ...
            <div class="col-6 middle">
                <div class="card">
                    ...
                    <div class="card-body card-body-paddding">
                        ...
                        <form method="POST" action="{{route('update.stores.categories')}}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" value="{{ $category_language->storeCategory->id }}" name="category_id">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="category">
                                    ...
                                    @foreach ($all_categories as $category)
                                        <option value="{{ $category->id }}" {{ $category_language->storeCategory->parent_id == $category->id ? 'selected' : ''}}>{{ $category->getTranslation('title', \App::getLocale()) }}</option>
                                        @foreach ($category->childCategories as $childCategory)
                                            @include('admin.stores.categories.child-categories', ['child_category' => $childCategory , 'parent' => $category_language->storeCategory->parent_id])
                                        @endforeach
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input id="ordering" type="number" class="form-control" name="ordering" value="{{ old('ordering') ? old('ordering') : $category_language->storeCategory->ordering }}"
                            ...
                            <div class="form-group">
                                ...
                                <input id="slug" type="text" class="form-control" name="slug" value="{{ old('slug') ? old('slug') : $category_language->storeCategory->slug }}"
                            ...
                            <div class="form-group">
                                ...
                                <input id="commission" type="number" class="form-control" step="any" name="commission" value="{{ old('commission') ? old('commission') : $category_language->storeCategory->commission }}"
                                ...
                                <div class="input-group category-icon-selector">
                                    <div class="input-group-append" id="uip-select-input">
                                        <div class="input-group-text"
                                            ...
                                            <i class="{{ $category_language->storeCategory->icon }}">{{ $category_language->storeCategory->icon ? '' : '?' }}</i>
                                        </div>
                                    </div>
                                    <input type="text" name="icon" id="uip-select-input-value"
                                           value="{{ old('icon') ? old('icon') : $category_language->storeCategory->icon }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="input-group gallery-modal" id="btnSubmit"  data-for="image" data-selection="single"
                                        ...
                                        <input type="hidden" name="logo" value="{{ old('logo') !='' ? old('logo') : $category_language->storeCategory->logo_id }}" class="image-selected">
                                        <span class="form-control"><span class="counter">{{ $category_language->storeCategory->logo_id ? 1 : 0 }}</span> {{ __('file chosen') }}</span>
                                    ...
                                    <div class="selected-media-box">
                                        <div class="mt-4 gallery gallery-md d-flex">
                                            @php
                                                $thumb = old('logo') ? old('logo') : $category_language->storeCategory->logo_id;
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="input-group gallery-modal" id="btnSubmit"  data-for="image" data-selection="single"
                                         data-target="#galleryModal" data-dismiss="modal">
                                        <input type="hidden" name="banner" value="{{ old('banner') !='' ? old('banner') : $category_language->storeCategory->banner_id }}" class="image-selected">
                                        <span class="form-control"><span class="counter">{{ $category_language->storeCategory->banner_id ? 1 : 0 }}</span> {{ __('file chosen') }}</span>
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                {{ __('Choose File') }}
                                            </div>
                                    ...
                                    <div class="selected-media-box">
                                        <div class="mt-4 gallery gallery-md d-flex">
                                            @php
                                                $banner = old('banner') ? old('banner') : $category_language->storeCategory->banner_id;
