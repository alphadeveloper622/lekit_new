                                        ...
                                        <tr id="row_{{ $category->id }}" class="table-data-row">
                                            ...
                                            <td>
                                                @if(hasPermission('category_update'))
                                                    <a href="{{route('edit.stores.categories',$category->id)}}"
                                                ...
                                                @if(hasPermission('category_delete'))
                                                    <a href="javascript:void(0)"
                                                       onclick="delete_row('delete/store_categories/',{{$category->id}})"
                    ...
                    <div class="col-sm-xs-12 col-md-5">
                        <div class="card">
                            ...
                            <div class="card-body card-body-paddding">
                                <form method="POST" action="{{route('store.stores.categories')}}">
                                    @csrf
                                        ...
                                        <select class="form-control selectric lang" name="category">
                                            ...
                                            @foreach($all_categories as $key => $category)
                                                ...
                                                @foreach ($category->childCategories as $childCategory)
                                                    @include('admin.stores.categories.child-categories', ['child_category' => $childCategory])
                                                @endforeach
                                            @endforeach
                                        </select>
