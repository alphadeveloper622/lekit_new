    ...
    <section class="section">
        <div class="section-body">
            <div class="d-flex justify-content-between">
                <div class="d-block">
                    <h2 class="section-title">{{ __('Seller Products') }}</h2>
            ...
            @php
                $all = DB::table('products')->Where('user_id','!=', 1)->where('is_deleted',0)
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    @if(isset($product->sellerProfile))
                                                        <br>{{ $product->sellerProfile->shop_name }}
                                                    @endif
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                @else
                                                    <label class="custom-switch mt-2 {{ (hasPermission('product_update') && $product->status != 'trash' ) ? '' : 'cursor-not-allowed' }}">
                                                        <input type="checkbox"
                                                               ...
                                                               class="{{ hasPermission('produt_update') ? 'product-status-change' : '' }} custom-switch-input">
                                                ...
                                                @if($product->status != 'trash')
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        @if(hasPermission('product_update'))
                                                            ...
                                                            @else
                                                                <a href="{{ route('product.status.change', ['status'=>'published','id'=>$product->id]) }}"
                                                                   class="dropdown-item has-icon"><i
                                                                        class='bx bx-check-shield'></i>{{ __('Published') }}
                                                                </a>
                                                                <a href="{{ route('product.status.change', ['status'=>'unpublished','id'=>$product->id]) }}"
                                                                   class="dropdown-item has-icon"><i
                                                                        class='bx bx-shield-x'></i>{{ __('Unpublished') }}
                                                                </a>
                                                            @endif
