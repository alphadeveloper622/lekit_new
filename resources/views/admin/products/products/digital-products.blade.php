    ...
    <section class="section">
        <div class="section-body">
            <div class="d-flex justify-content-between">
                <div class="d-block">
                    <h2 class="section-title">{{ __('Digital Products') }}</h2>
                ...
                @if(hasPermission('product_create'))
                    <div class="buttons add-button">
                        <a href="{{ route('digital.product.create') }}" class="btn btn-icon icon-left btn-outline-primary">
                            <i class='bx bx-plus'></i>{{ __('Add new Digital Product') }}
                        </a>
