                                        ...
                                        <select class="filter-categories-by-ajax form-control select2" name="c" id="c">
                                            ...
                                            @if(isset($c))
                                                @if($selected_category != null)
                                                    <option selected
                                                            value="{{ @$c }}"> {{ $position.@$selected_category->getTranslation('title', App::getLocale()) }} </option>
                                                @endif
                                            @endif
                                        </select>
                                    </div>
                                    ...
                                    @foreach($products as $key => $product)
                                        <tr id="row_{{$product->id}}">
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <label class="custom-switch mt-2 {{ (hasPermission('product_update') && $product->status != 'trash') ? '' : 'cursor-not-allowed' }}">
                                                        <input type="checkbox"
                                                               @if(hasPermission('product_update') && $product->status != 'trash') value="product-status-change/{{$product->id}}/status"
                                                               @endif
                                            ...
                                            <td>
                                                <label class="custom-switch mt-2 {{ (hasPermission('product_update') && $product->status != 'trash') ? '' : 'cursor-not-allowed' }}">
                                                    <input type="checkbox"
                                                           @if(hasPermission('product_update') && $product->status != 'trash') value="product-status-change/{{$product->id}}/is_catalog"
                                                           @endif
                                            ...
                                            <td>
                                                <label class="custom-switch mt-2 {{ (hasPermission('product_update') && $product->status != 'trash') ? '' : 'cursor-not-allowed' }}">
                                                    <input type="checkbox"
                                                           @if(hasPermission('product_update') && $product->status != 'trash') value="product-status-change/{{$product->id}}/todays_deal"
                                                           @endif
                                            ...
                                            <td>
                                                <label class="custom-switch mt-2 {{ (hasPermission('product_update') && $product->status != 'trash') ? '' : 'cursor-not-allowed' }}">
                                                    <input type="checkbox"
                                                           @if(hasPermission('product_update') && $product->status != 'trash') value="product-status-change/{{$product->id}}/is_featured"
                                                           @endif
