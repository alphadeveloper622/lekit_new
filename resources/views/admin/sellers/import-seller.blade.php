    ...
    <section class="section">
        <div class="section-body">
            <div class="d-flex justify-content-between">
                <div class="d-block">
                    <h2 class="section-title">{{ __('Import Sellers') }}</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-xs-12 col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ __('Import Sellers') }}</h4>
                        </div>
                        <div class="card-body col-sm-xs-12">
                            <form method="POST" action="{{ route('admin.seller.import.post') }}" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="col-sm-xs-12 col-md-6">
                    <div class="card">
                        <div class="card-header input-title">
                            <h4>{{ __('Seller Import Procedures') }}</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <ol>
                                ...
                                <li>phone {{ __('or') }} email {{ __('must be provided') }}</li>
                                ...
                                <a href="{{route('admin.import.sample','seller')}}" target="_blank">
                                    <span class="nk-menu-icon"><i class="bx bx-download"></i></span>
                                    <span class="nk-menu-text">{{__('Seller Import Sample Download')}}</span>
                                </a>
                            </ol>
                        </div>
                    </div>
