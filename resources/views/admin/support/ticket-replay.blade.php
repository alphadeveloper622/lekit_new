            ...
            <div class="row">
                <div class="col-md-8 middle">
                    <div class="card">
                        ...
                        <form action="{{route('ticket.replay.store')}}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group row mb-12">
                                        <div class="col-sm-12 col-md-12">
                                            ...
                                            <input type="hidden" name="type" value="{{$admin_user->user_type}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="dropdown-menu">
                                        @if(hasPermission('support_update'))
                                            <a href="{{route('ticket.replay.edit',$replay->id)}}" class="dropdown-item has-icon"><i class="bx bx-edit"></i> {{ __('Edit') }}</a>
                                        @endif
                                    ...
                                    <div class="hero pb-2">
                                        <div class="">
                                                <div class="chat-item chat-left chat-item-margin">
                                                    <img class="chat-imag rounded-circle" src="{{static_asset($admin_user->images !=null && file_exists($admin_user->images['image_40x40']) ? $admin_user->images['image_40x40'] : 'images/default/user45x45.jpg')}}" />
                                ...
                                <div class="card customer-chat-clr" >
                                    ...
                                    <div class="card-body chat-content">
                                        <div class="hero pb-2">
                                            <div class="">
                                                <div class="chat-item chat-left chat-item-margin">
                                                    <img class="chat-imag rounded-circle" src="{{static_asset($support->user->images !=null && file_exists($support->user->images['image_40x40']) ? $support->user->images['image_40x40'] : 'images/default/user45x45.jpg')}}" />
                                                    <div class="chat-details">
                                                        @if(!blank($replay->replay))
