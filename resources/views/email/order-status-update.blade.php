                ...
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="text-align: center; padding: 50px 30px 10px 30px;">
                            <h2 class="email-heading">{{ __('Your Order Status Is Updated !') }}</h2>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 15px 30px">
                            <p>{{__('hi')}} {{ $content->first_name .' '.$content->last_name }},</p>
                            <p>{{ __("Your order :code Status is :delivery_status now", ['code'=> $content->code,'delivery_status' => $content->delivery_status]) }}</p>
                            <a href="{{ $url }}" class="email-btn">{{ __('Details') }}</a>
                        </td>
                    </tr>
