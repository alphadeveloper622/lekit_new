                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 50px 30px;">
                                    <img style="width:88px; margin-bottom:24px;" src="{{ static_asset('/images/default/kyc-success.png')}}" alt="Verified">
                                    <h2 style="font-size: 18px; color: {{$color}}; font-weight: 400; margin-bottom: 8px;">{{__('Your Password Successfully Reset')}}</h2>
                                    <p>{{__('if you think anything wrong with your account, Just contact with us.')}}</p>
                                </td>
                            </tr>
