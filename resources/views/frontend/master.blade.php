<!DOCTYPE html>
<html lang="{{ $active_language ? $active_language->locale : 'uk' }}"
...
<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyBX6xSl7_lNgUUuO4Pkhse9NnTS9GJrm5M"></script>
