        ...
        <div class="section-body">
            <div class="d-flex justify-content-between">
                ...
                <div class="buttons add-button">
                    <a href="{{ route('seller.classified.product.create') }}" class="btn btn-icon icon-left btn-outline-primary">
                        <i class='bx bx-plus'></i>{{ __('Add new Classified Product') }}
                    </a>
            ...
            @php
                $all            = DB::table('products')->where('is_deleted',0)->where('user_id', Sentinel::getUser()->id)->where('is_classified',1)->get();
                $total          = $all->count();
