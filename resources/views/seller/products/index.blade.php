        ...
        <div class="section-body">
            <div class="d-flex justify-content-between">
                ...
                <div class="buttons add-button">
                    <a href="{{ route('seller.product.create') }}" class="btn btn-icon icon-left btn-outline-primary">
            ...
            @php
                $all            = DB::table('products')->where('is_deleted',0)->where('user_id', Sentinel::getUser()->id)->get();
                $total          = $all->count();
                                ...
                                <table class="table table-striped table-md">
                                    ...
                                    @foreach($products as $key => $product)
                                        <tr id="row_{{$product->id}}">
                                            ...
                                            <td>
                                               <span>
                                                    {{ __('Price').': ' .get_price($product->price,user_curr()).' /'.$product->getTranslation('unit', \App::getLocale()) }}</span>
                                                <br>
                                            ...
                                            <td>
                                                <label class="cursor-not-allowed custom-switch mt-2">
                                                    <input type="checkbox"
