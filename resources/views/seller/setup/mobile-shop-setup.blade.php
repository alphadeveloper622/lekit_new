...
@section('title')
    {{ __('Update Your Mobile Shop') }}
@endsection
@section('mobile_app_contents')
    active
@endsection
...
@section('main-content')
    <section class="section">
        ...
        <div class="section-body">
            <form action="{{ route('seller.mobile.shop.update') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="col-12 col-sm-12 col-md-8 col-lg-9">
                        <div class="home-content" id="dragger-brop-menu">
                            @php
                                $content_count = 0;
                            @endphp
                            @if(Sentinel::getUser()->sellerProfile->mobile_shop_page_contents != [] && gettype(Sentinel::getUser()->sellerProfile->mobile_shop_page_contents) == 'array')
                                @foreach(Sentinel::getUser()->sellerProfile->mobile_shop_page_contents as $contents)
                                    @php
    ...
    <input type="hidden" name="shop_content" value="1" class="shop_content">
