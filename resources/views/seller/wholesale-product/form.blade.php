...
@section('main-content')
    <section class="section">
        <div class="section-body">
            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-9 middle">
                <div class="mb-3 bg-white px-4 py-2">
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link bar {{ old('sms_method') == 'fast_2' ? 'active' : '' }} {{ has_key(['price','special_discount_type','special_discount','special_discount_period','vat_taxes','has_variant','low_stock_to_notify','stock_visibility',
                        ...
                        <li class="nav-item">
                            <a class="nav-link bar {{ old('sms_method') == 'spagreen_sms' ? 'active' : '' }} {{ has_key(['short_description','description','pdf_specification'],$errors) ? 'error' : '' }}"
                        ...
                        @if(!isset($is_catalog))
                            @if(!isset($is_classified))
                                <li class="nav-item">
                                    <a class="nav-link bar {{ old('sms_method') == 'nexmo_sms' ? 'active' : '' }} {{ has_key(['shipping_type','shipping_fee','shipping_fee_depend_on_quantity','cash_on_delivery','is_digital','estimated_shipping_days','product_file'],$errors) ? 'error' : '' }} }}" id="shipping-tab" data-toggle="tab" href="#shipping" role="tab"
                                       aria-controls="profile"
                                       aria-selected="false">{{ __('Shipping Info') }}</a>
                                </li>
                            @endif
                        @endif
                        @if(addon_is_activated('refund') || isset($is_catalog))
                            <li class="nav-item">
                                <a class="nav-link bar {{ old('sms_method') == 'ssl_wireless' ? 'active' : '' }} {{ has_key(['campaign','campaign_discount','campaign_discount_type','is_refundable','is_featured','todays_deal','external_link'],$errors) ? 'error' : '' }}" id="others-tab" data-toggle="tab" href="#others"
                                   role="tab" aria-controls="contact"
                                   aria-selected="false">{{ __('Others') }}</a>
                            </li>
                        @endif
                        <li class="nav-item">
                            <a class="nav-link bar {{ old('sms_method') == 'mimo_sms' ? 'active' : '' }} {{ has_key(['meta_title','meta_description','meta_image','meta_keywords'],$errors) ? 'error' : '' }}" id="seo-tab" data-toggle="tab" href="#seo" role="tab"
                               aria-controls="contact"
            ...
            <form action="{{ route('seller.wholesale.product.create.post') }}" method="post"
                    ...
                    <div class="col-12 col-sm-12 col-md-8 col-lg-9 middle">
                        <div class="tab-content no-padding" id="myTabContent2">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control ai_content_name" name="name" id="name"
                            ...
                            <div class="tab-pane fade" id="price-and-stock" role="tabpane1" aria-labelledby="price-and-stock-tab">
                                ...
                                <div class="card">
                                    <div class="card-header d-flex justify-content-space-between card-header">
                            ...
                            <div class="tab-pane fade" id="description-and-specification" role="tabpane6" aria-labelledby="description-and-specification-tab">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <textarea type="text" class="form-control ai_short_description" name="short_description"
                                        ...
                                        <div class="form-group">
                                            <label for="description" class="form-control-label">{{ __('Content') }}</label>
                                            <div>
                                                @include('admin.ai_writer.ai_btn',[
                                                    'name' => 'ai_description',
                                                    'length' => '259',
                                        ...
                                        @if(settingHelper('shipping_fee_type') == 'product_base')
                                            ...
                                            <div class="form-group mt-2">
                                                ...
                                                <select class="form-control selectric shipping-type" name="shipping_type"
                                                    ...
                                                    <option
                                                        value="free_shipping" {{ old('shipping_type') == 'free_shipping' ? 'selected' : '' }} selected>{{ __('Free Shipping') }}</option>
                                                </select>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#add-menu-item").on("click", function () {
                var $copy = $(".drag-brop-menu").find('.menu-item').last();
                var new_id = parseInt($copy.attr("data-id")) + 1;

                var $pasteBefore = $(".drag-brop-menu").find('.menu-item').last();
                $copy.clone().insertBefore($pasteBefore);
                $copy = $copy.attr("data-id", new_id);
