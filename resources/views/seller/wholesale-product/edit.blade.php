...
@php
    $route = isset($clone) ? route('seller.wholesale.product.clone.store') : route('seller.wholesale.product.update');
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="slug" id="slug" class="form-control" value="{{ old('slug') ? old('slug') : (isset($clone) ? '' : ($product_language ? $product_language->product->slug : '')) }}" placeholder="{{__('Product Slug')}}">
                                            @if ($errors->has('slug'))
                                                <div class="invalid-feedback">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body extra-padding">
                                        @if(addon_is_activated('refund'))
                                            <div class="section-title mt-2">{{ __('Status') }}</div>
                                            <div class="form-group row mt-2">
