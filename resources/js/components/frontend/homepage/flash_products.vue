	...
	<section class="products-section" v-if="lengthCounter(products) > 0">
		<div class="container">
			<div class="title justify-content-between" :class="{ 'title-bg' : addons.includes('ishopet') }">
				...
				<div class="flash-sales-timer" v-if="addons.includes('ishopet')">
					<ul class="time-counter d-flex">
						<li>Time Left</li>
						<li>00h</li>
						<li>16m</li>
						<li>49s</li>
			...
			<productCarouselList :products="products" :grid_class="'grid-2'" :type="'flash'"></productCarouselList> </div><!-- /.container -->
	</section>
