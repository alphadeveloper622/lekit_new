<template>
  <section class="brand-section item-space-rmv" v-if="countBrand > 0">
    <div class="container">
      ...
      <div class="category-content" :class="{ 'slider-arrows' : addons.includes('ishopet') }">
          ...
          <div v-if="countBrand > 0" v-for="(brand,index) in brands" :key="index">
            <div class="brand margin_right_18">
              <div class="brand_image">
                <a class="slider_div\" :href="getUrl('brand/'+brand.slug)" @click.prevent="routerNavigator('product.by.brand',brand.slug)">
