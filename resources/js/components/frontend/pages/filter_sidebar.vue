			...
			<div class="container">
				<div class="row sg-category-content sg-filter grid-view-tab" :class="activeClass">
					<div class="col-md-4 col-lg-3 filter_area" v-if="lengthCounter(productList) > 0">
								...
								<div class="accordion-item" v-if="!category_routes.includes(form.route)">
									...
									<div id="category" class="accordion-collapse collapse" :class="{ show: category }" aria-labelledby="ac1">
										<div class="accordion-body">
											...
											<div v-if="category_load_more || categories.next_page_url"><a @click="loadCategories" href="javaScript:void(0)">{{ lang.show_more }}</a></div>
										</div>
									</div>
								</div>
                        ...
                        <div v-if="brands.data && brands.data.length>0" v-observe-visibility="handleScrolledForBrands"></div>
											</form>
										</div>
									</div>
								</div>
								...
								<div class="accordion-item" v-if="settings.color == 1">
									...
									<div id="collapse5" class="accordion-collapse collapse" :class="{ show: color }" aria-labelledby="ac5">
										<div class="accordion-body">
											<form action="#" class="form-checkbox">
												<div class="form-group" v-for="(color, index) in colors.data" :key="'color' + index" v-observe-visibility="index === colors.data.length - 1 ? handleScrolledForColors : false">
						...
						<div class="sg-category-content sg-filter" :class="activeClass">
							<div class="cta mb-4" v-if="page && page.image_835x200">
								<div v-if="page.image_835x200 == getUrl('images/default/default-image-835x200.png')">
									<a v-if="settings.category_default_banner != null"><img loading="lazy" :src="settings.category_default_banner" :alt="form.slug" class="img-fluid" /></a>
									<a v-else><img loading="lazy" :src="page.image_835x200" :alt="form.slug" class="img-fluid" /></a>
								</div>
								<div v-else>
									<a v-if="page.image_835x200"><img loading="lazy" :src="page.image_835x200" :alt="form.slug" class="img-fluid" /></a>
								</div>
							</div>
