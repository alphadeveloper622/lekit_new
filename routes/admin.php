    ...
    Route::group(
        ...
        Route::middleware(['adminCheck','loginCheck'])->group(function () {
            ...
            Route::prefix('admin')->group(function () {
                ...
                Route::put('stores-category-status-change', [StoresCategoryController::class, 'statusChane'])->name('stores.category.status.change')->middleware('PermissionCheck:category_update');
